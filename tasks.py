...
# TODO Регистрация учителя через сайт
# TODO Аутентификация учителя (авторизация через логин и пароль)
# TODO Добавлять, читать, изменять, удалять(CRUD) учеников
# TODO После создания ученика, отправить ему email уведомление
# TODO Поиск учеников
# TODO Отправлять сообщение на mail учеников(рассылка
